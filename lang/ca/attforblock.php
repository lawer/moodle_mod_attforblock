...
$string['add'] = 'Agregar';
$string['addmultiplesessions'] = 'Agregar varies sessions';
$string['addsession'] = 'Agregar sessió';
$string['allcourses'] = 'Tots els cursos';
$string['allpast'] = 'Fins avui';
$string['attendanceforthecourse'] = 'Assistència pel Curs/Assignatura';
$string['attendancegrade'] = 'Puntuació Assistència';
$string['attendancenotstarted'] = 'L\'assistpencia encara no ha començat en aquest curs';
$string['attendancepercent'] = 'Porcentatje';
$string['attendancereport'] = 'Informe d\'asisstència';
$string['attendancesuccess'] = 'Asisstència presa exitosament';
$string['attendanceupdated'] = 'Asisstència actualitzada exitosament';
$string['attforblock:canbelisted'] = 'Apareixer en la llista';
$string['attforblock:changeattendances'] = 'Canviar asisstència';
$string['attforblock:changepreferences'] = 'Canviar preferències';
$string['attforblock:export'] = 'Exportar Informes';
$string['attforblock:manageattendances'] = 'Gestionar asisstència';
$string['attforblock:takeattendances'] = 'Prendre asisstència';
$string['attforblock:view'] = 'Veure asisstències';
$string['attforblock:viewreports'] = 'Veure Informes';
$string['attrecords'] = 'Asisstències preses';
$string['calclose'] = 'Tancar';
$string['calmonths'] = 'Gener, Febrer, Març, Abril, Maig, Juny, Juliol, Agost, Setembre, Octubre, Novembre, Desembre';
$string['calshow'] = 'Seleccione data';
$string['caltoday'] = 'Avui';
$string['calweekdays'] = 'Diu, Dil, Dim, Dix, Dij, Div, Dis';
$string['changeduration'] = 'Canviar duració';
$string['changesession'] = 'Canviar sessió';
$string['column'] = 'columna';
$string['columns'] = 'columnes';
$string['commonsession'] = 'Comú';
$string['commonsessions'] = 'Comunes';
$string['countofselected'] = 'Recompte de selecció';
$string['copyfrom'] = 'Copiar assistpencia desde';
$string['createmultiplesessions'] = 'Crear multiples sessions';
$string['createonesession'] = 'Crear una sessió pel curso';
$string['days'] = 'Avui';
